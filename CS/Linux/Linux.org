...
*** After installing a new operation system:
*very important:*
...
build-essential cmake git unzip pkg-config python-pip
...
mkdir cuda_installer && cd cuda_installer
...
#+END_SRC
5. replace content of .zshrc with bashrc
...
#+END_SRC
7. check nvidia driver installation
#+BEGIN_SRC bash
nvidia-smi
#+END_SRC
#+RESULTS
