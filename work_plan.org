...
** <2017-09-19 Tue>
- [ ] buy and hold mode on future backtesting.
...
- [X] download wti data from quandl as test data.
- [ ] roll over between two contracts to get continious contract data.
- [ ] create signal via continous contract data.
