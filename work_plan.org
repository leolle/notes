...
- [ ] modify python content aligned with python library index.
...
DEADLINE: <2017-10-11 Wed>
- [ ] add abnormal factors on GS
- [ ] add computer age statistical inference function content on GS
- [ ] strategies
- [ ] stocks
- [X] f def
- [X] abnormal factors
...
* TODO optimization
DEADLINE: <2017-09-27 Wed> SCHEDULED: <2017-09-27 Wed>
