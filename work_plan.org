...
:END:
- [ ] create test program to run word embedding, to visualize output.
- [ ] test function word embedding.
...
- [X] visualize vocabulary embedding using t-SNE which project embedding vectors into 2-D surface from an proper perspective using tensorboard locally.
