...
- [ ] train Chinese wiki model.
  assign wiki pages extraction task.
  insert Chinese wiki to mongo, transform traditional Chinese to simple Chinese.
  retrie Chinese financial wiki pages from mongo and train.
