...
- [X] plot graph.
- [X] pseudo code.
****** TODO implementation usecase on GS.
- [X] create a research article node of pdf format.
- [ ] convert the pdf to text.
- [ ] get the highlight of the text.
- [ ] create highlight nodes on GS.
- [ ] feed the highlight into next step.
****** customize textrank to textrank4zh, change output keywords number.
...
| <2018-04-08 Sun> | AB58600B83DE46EEB51EA925E9CCBAC0 | keywords_extraction                               |
