...
****** Download with the article title:
1. [X] Find meta data with article title from crossref.org API.

2. [ ] Download specific articles directly(article url) or via sci-hub based on DOI.

The actual pdf source url behind sci-hub is embedded in a iframe with the link looks something like


****** Download a collection of articles by passing in file of DOIs/URLs.
- [ ] Search for articles on Google Scholar and download them.
- [ ] Search Google Scholar.
- [ ] Download pdf directly if possible.
- [ ] Download specific articles directly(article url) or via sci-hub based on url.
...
- [ ] 2. Search for articles on Google Scholar and download them:
