...
- [ ] pulling wiki knowledge categories(id), pages(id) and relations to local csv, sql file.
- [ ] import sql file to neo4j, or MySQL.
...
:END:
- [X] calculate calculate factor return and residual(specific risk).
