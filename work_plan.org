...
- [ ] portfolio construction with black-litterman model.
...
** <2017-09-26 Tue>
- [ ] learn function define, function sampling instance, wants, search strategy run on GS.
- [ ] add trading volume and other value to the continuous contract.
- [ ] remove unnecessary input of the parsing function.
- [ ] create long/short strategy, return neutral position.
