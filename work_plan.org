...
- [ ] build RNN tensorflow code.
- [ ] pseudo code for GRU attention Relation Extraction.
- [ ] 看deep learning for information extraction书relation extraction和event extraction.
- [ ] 写summary。

***** TextRank
- [ ] test text rank example.
- [ ] paper - TextRank: Bringing Order into Texts.
- [ ] pseudo code.
- [ ] implementation on GS.
- [ ] plot graph.
