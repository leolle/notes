...
:LOGBOOK:
CLOCK: [2017-11-04 Sat 12:46]--[2017-11-04 Sat 12:46] =>  0:00
CLOCK: [2017-11-04 Sat 12:44]--[2017-11-04 Sat 12:44] =>  0:00
:END:
...
3. [ ] Create topics OSET and Want based on topics idea
   1. Such want can be under project want or
   2. under agent want such as SSRN, Journal
4. [ ] Create a Want workflow to research the topics, e.g.,
   1. find top school and authors of that topics
   2. find top papers chronologically in that topics
5. [ ] Search top papers and websites under the topics
   1. meet the wants in research workflow with top author, school, etc
6. [ ] Download those papers and Meet the Want(s) of that topics
7. [ ] Create an idea workflow for such topics
