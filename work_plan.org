...
****** TODO train model to recognize company, indicator, signal.
...
**** TODO extract keywords from documents, create a knowledge graph.
...
**** NLP information system workflow
...
1. calculate similarity between target task and current website theme.
2. calculation process:
#1. embedding all available task instance.
#2. use keywords, search name of task.

****** TODO usecase 2 highligh entities according to GS task:
